...
const Cabaña5 = () => {
  ...
  async function getEventos(){
    const eventosCol = collection(db, "Cabaña5");
  ...
  return (
    <>
        <h2 className='text-white pb-4'>Cabaña 5 <span className="badge rounded-pill bg-info">*</span></h2>
        ...
        <Formulario
        nombreCabana={" - Cabaña 5"}
        capacidad={5}
        color={"cyan"}
        nombreDB={"Cabaña5"}/>
        <TodasReservas
        nombreCabaña={"Cabaña5"}
        nombreCabanaB={"Cabaña 5"}
        Db={Db}
        />
    </>
